...
PREFERRED_SHEET_NAME = "polymer 3"
...
def load_polymer3_sheet(path, preferred_name="polymer 3"):
    """Open 'Polymer 3' sheet by name if present (case-insensitive); otherwise first sheet."""
...
df, used_sheet = load_polymer3_sheet(excel_path, PREFERRED_SHEET_NAME)
...
out_path = Path(excel_path).with_name("DT_Polymer3_predictions.xlsx")
